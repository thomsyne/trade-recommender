...
READINESS_BACKUP_STATE_DIR = os.getenv("READINESS_BACKUP_STATE_DIR", "") or (
    str(Path(READINESS_BACKUP_MARKER).parent) if READINESS_BACKUP_MARKER else ""
)
READINESS_DISK_PATH = os.getenv("READINESS_DISK_PATH", str(BASE_DIR))
CAPACITY_DISK_WARNING_FREE_GB = float(os.getenv("CAPACITY_DISK_WARNING_FREE_GB", "5"))
CAPACITY_MEMORY_WARNING_PERCENT = float(os.getenv("CAPACITY_MEMORY_WARNING_PERCENT", "20"))
CAPACITY_MEMORY_CRITICAL_PERCENT = float(os.getenv("CAPACITY_MEMORY_CRITICAL_PERCENT", "10"))
CAPACITY_MEMINFO_PATH = os.getenv("CAPACITY_MEMINFO_PATH", "/proc/meminfo")
APP_SOURCE_REVISION = os.getenv("APP_SOURCE_REVISION", "").strip() or "unknown"
APP_BUILD_CREATED = os.getenv("APP_BUILD_CREATED", "").strip() or "unknown"
APP_IMAGE_URI = os.getenv("IMAGE_URI", "").strip()

OANDA_ENVIRONMENT = os.getenv("OANDA_ENVIRONMENT", "practice")
OANDA_ACCOUNT_ID = os.getenv("OANDA_ACCOUNT_ID", "")
OANDA_TOKEN = os.getenv("OANDA_TOKEN") or os.getenv("OANDA_API_KEY_TEST", "")
OANDA_DISCOVERY_TOKEN = os.getenv("OANDA_API_KEY_TEST", "")
...
RECOMMENDATION_PRICING_VERSION = os.getenv(
    "RECOMMENDATION_PRICING_VERSION", "anthropic-standard-2026-08-10"
)
