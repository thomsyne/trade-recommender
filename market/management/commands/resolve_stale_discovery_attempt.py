...
from market.historical_discovery import resolve_stale_discovery_attempt


class Command(BaseCommand):
    help = "Explicitly fail one stale discovery attempt without retrying it"
    ...
    def handle(self, *args, **options):
        try:
            attempt = resolve_stale_discovery_attempt(
                options["attempt_id"],
